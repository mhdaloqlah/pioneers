...
export default function FAQs() {
  ...
  return (
    ...
    alignItems: 'center',}} className="faqs__section section__padding  " id="faqs">
      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} defaultExpanded sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
...
<span style={{margin:"0 50px"}}>كما يقدم المركز فرصة إصدار كتب مستقلة لمن يرغب من رواد التنمية في الإمارات</span>
      ...
      <Accordion expanded={expanded === 'panel7'} onChange={handleChange('panel7')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel8'} onChange={handleChange('panel8')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
      ...
      <Accordion expanded={expanded === 'panel9'} onChange={handleChange('panel9')}  sx={{ backgroundColor: "inherit", color: "#b5964dc8", boxShadow: "none" }}>
        <AccordionSummary
          expandIcon={<ExpandMoreIcon sx={{ color: "#b5964dc8" }} />}
          aria-controls="panel1-content"
          id="panel1-header"
